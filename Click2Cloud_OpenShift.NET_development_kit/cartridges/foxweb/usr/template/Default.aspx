...
<script runat="server">
    protected void Button1_Click(object sender, System.EventArgs e)
    {
        if (Label1.Text == string.Empty)
        {
            ...
            Label1.Text = envVars;
            Button1.Text = "Hide Environment Variables";
        }
        else
        {
            Label1.Text = string.Empty;
            Button1.Text = "Display Environment Variables";
        }
    }
...
<body>
    <form id="form1" runat="server">
        <section class='container'>
          <hgroup>
            <h1>Welcome to your FoxWeb application on OpenShift</h1>
          </hgroup>
        ...
        <asp:Label ID="Label1" runat="server" Font-Size="Smaller" ForeColor="Crimson"></asp:Label> 
              ...
              <section>
                  <br />
                  <a href="Authenticate.fwx">Go to FoxWeb Authentication</a>
                  <br />
                  </section>
            <section>
